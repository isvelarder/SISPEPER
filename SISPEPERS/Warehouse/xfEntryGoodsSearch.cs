...
namespace SISPEPERS
{
    public partial class xfEntryGoodsSearch : XtraForm
    {
        public xfEntryGoodsSearch()
        {
            InitializeComponent();
        }

        public BEEntryGoods rowsel { get; set; }
        private void Search()
        {
            try
            {
        ...
        private void Get_RowSelecion()
        {
            try
            {
                ...
                rowsel = (BEEntryGoods)gdvSearch.GetRow(gdvSearch.FocusedRowHandle);
