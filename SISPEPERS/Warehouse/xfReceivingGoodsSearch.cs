...
namespace SISPEPERS
{
    public partial class xfReceivingGoodsSearch : XtraForm
    {
        public xfReceivingGoodsSearch()
        {
            InitializeComponent();
        }

        public BEReceivingGoods rowsel { get; set; }
        private void Search()
        {
            try
            {
        ...
        private void Get_RowSelecion()
        {
            try
            {
                ...
                rowsel = (BEReceivingGoods)gdvSearch.GetRow(gdvSearch.FocusedRowHandle);
