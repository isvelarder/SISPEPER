...
namespace SISPEPERS
{
    public partial class xfCreditNoteSearch : XtraForm
    {
        public xfCreditNoteSearch()
        {
            InitializeComponent();
        }
        ...
        private void Search()
        {
            try
            {
                ...
                var olst = obr.Get_PSCP_SPLS_SCPC_ORPC(opar);
        ...
        private void xfCreditNoteSearch_Load(object sender, EventArgs e)
        {
            Get_Load();
        }
