...
namespace SISPEPERS
{
    public partial class xfInvoiceSearch : XtraForm
    {
        public xfInvoiceSearch()
        {
            InitializeComponent();
        }
        ...
        private void Search()
        {
            try
            {
                ...
                var olst = obr.Get_PSCP_SPLS_SCPC_OINV(opar);
        ...
        private void xfInvoiceSearch_Load(object sender, EventArgs e)
        {
            Get_Load();
        }
