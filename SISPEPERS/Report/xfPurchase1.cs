...
{
    public partial class xfPurchase1 : XtraForm
    {
        ...
        private static xfPurchase1 mSgIns;
        public static xfPurchase1 SgIns
        {
            get
            {
                if (mSgIns == null || mSgIns.IsDisposed)
                    mSgIns = new xfPurchase1();
                return (mSgIns);
            }
            set
            {
        ...
        private void Get_Search()
        {
            try
            {
                ...
                var olst = obr.Get_PPRP_SPLS_COM1(obj);
