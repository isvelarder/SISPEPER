...
{
    public partial class xfPurchase2 : XtraForm
    {
        ...
        private static xfPurchase2 mSgIns;
        public static xfPurchase2 SgIns
        {
            get
            {
                if (mSgIns == null || mSgIns.IsDisposed)
                    mSgIns = new xfPurchase2();
                return (mSgIns);
            }
            set
            {
        ...
        private void Get_Search()
        {
            try
            {
                ...
                var olst = obr.Get_PPRP_SPLS_COM2(obj);
