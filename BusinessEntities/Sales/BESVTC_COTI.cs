...
namespace BusinessEntities.Sales
{
    public class BESVTC_COTI
    {
        ...
        public DateTime? FEC_NEGO { get; set; }
        ...
        public decimal NUM_TASA_DIAA { get; set; }
        public decimal NUM_FACT { get; set; }
        public decimal NUM_FACT_DESC { get; set; }
        ...
        public List<BESVTC_COTI> LST_FACT { get; set; }
